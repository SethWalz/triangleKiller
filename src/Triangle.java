...
public abstract class Triangle extends Region {
    Vector2D location;
    Vector2D velocity;
    ...
    Layer layer = null;
	public Triangle( Layer layer, Vector2D location, Vector2D velocity, Vector2D acceleration, double width, double height) {
